...
class User(UserMixin, db.Model):
        ...
        def read_input_data(self, session_id):

                subfiles = [StringIO()] 
                with open('/Users/rkim/newco app/data/'+session_id) as bigfile:
                        count = 0
                        for line in bigfile:
        ...
        def add_all_new_sessions(self, all_scenarios_df):
                existing_session_instances = self.get_existing_scenario_instances()
                entries = os.scandir("/Users/rkim/newco app/data")
                for entry in entries:
                        if entry.name.startswith('.') == False and entry.name not in existing_session_instances:
                                subfile = self.read_input_data(entry.name)
                                new_session = TrainingInstance()
                                new_session.session_file_name = entry.name
                                new_session.user_id = self.id 
                                new_session.date_time = new_session.get_date_time(entry.name) #date and time of session
...
class Videos(db.Model):
    ...
    n1_original_content_tag=db.Column(db.String(100))
    n1_select_tag=db.Column(db.Integer)
    n1_description=db.Column(db.String(5000))
    tag_1=db.Column(db.String(30))
    tag_2=db.Column(db.String(30))
    tag_3=db.Column(db.String(30))
    tag_4=db.Column(db.String(30))
    tag_5=db.Column(db.String(30))
    tag_6=db.Column(db.String(30))
    tag_7=db.Column(db.String(30))
    tag_8=db.Column(db.String(30))
    tag_9=db.Column(db.String(30))
    tag_10=db.Column(db.String(30))
    tag_11=db.Column(db.String(30))
    tag_12=db.Column(db.String(30))
    tag_13=db.Column(db.String(30))
    tag_14=db.Column(db.String(30))
    tag_15=db.Column(db.String(30))
    tag_16=db.Column(db.String(30))
    tag_17=db.Column(db.String(30))
    tag_18=db.Column(db.String(30))
    tag_19=db.Column(db.String(30))
    tag_20=db.Column(db.String(30))
